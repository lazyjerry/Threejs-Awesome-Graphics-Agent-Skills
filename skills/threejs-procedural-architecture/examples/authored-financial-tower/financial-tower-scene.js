...
const [limestoneMap, limestoneNormal, ornamentMap, ornamentNormal] =
  await Promise.all([
    textureLoader.loadAsync(
      "/skills/threejs-procedural-architecture/examples/authored-financial-tower/assets/limestone-albedo.png",
    ),
    textureLoader.loadAsync(
      "/skills/threejs-procedural-architecture/examples/authored-financial-tower/assets/limestone-normal.png",
    ),
    textureLoader.loadAsync(
      "/skills/threejs-procedural-architecture/examples/authored-financial-tower/assets/ornaments-albedo.png",
    ),
    textureLoader.loadAsync(
      "/skills/threejs-procedural-architecture/examples/authored-financial-tower/assets/ornaments-normal.png",
    ),
  ]);
